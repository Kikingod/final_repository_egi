...
from website.core.agent_tools import sql_query, retriever_tool
...
primary_assistant_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "Use the provided tools to search for specific product information, company policies, and other information to assist the user's queries. "
            ...
            "Feel free to use emojis, crack jokes, and make the interaction fun! Use **bold** for important information and //italic// for emphasis."
            "\n\nCurrent user:\n<User>\n{user_info}\n</User>"
            "\nCurrent time: {time}.",
        ),
